<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="歌手名" prop="geshouming">
          <el-input v-model="ruleForm.geshouming" 
              placeholder="歌手名" clearable  :readonly="ro.geshouming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="歌手名" prop="geshouming">
              <el-input v-model="ruleForm.geshouming" 
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="歌曲" prop="gequ">
          <file-upload
          tip="点击上传歌曲"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.gequ?ruleForm.gequ:''"
          @change="gequUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.gequ" label="歌曲" prop="gequ">
            <el-button type="text" size="small" @click="download(ruleForm.gequ)">预览</el-button>
          </el-form-item>
        </div>    
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    gequUploadChange(fileUrls) {
	this.ruleForm.gequ = fileUrls;
			this.addEditUploadStyleChange()
    },
