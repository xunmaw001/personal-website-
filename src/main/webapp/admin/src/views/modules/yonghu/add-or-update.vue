<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="验证码" prop="yanzhengma">
          <el-input v-model="ruleForm.yanzhengma" 
              placeholder="验证码" clearable  :readonly="ro.yanzhengma"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="验证码" prop="yanzhengma">
              <el-input v-model="ruleForm.yanzhengma" 
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingming = true;
          ...
          if(o=='yanzhengma'){
            this.ruleForm.yanzhengma = obj[o];
	    this.ro.yanzhengma = true;
            continue;
          }
          if(o=='xingbie'){
