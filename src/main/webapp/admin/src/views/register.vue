  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 215, 0, 0.02);borderRadius:20px">
        <h1 class="h1" style="color:rgba(255, 69, 0, 1);fontSize:30px;">个人网站注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.yanzhengma" class="input" type="text" placeholder="验证码">
			   </div>
			 </div> -->
			<el-form-item label="验证码" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.yanzhengma" autocomplete="off" placeholder="验证码"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if((!this.ruleForm.yanzhengma) && `yonghu` == this.tableName){
