  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='yonghu'"  label="验证码" prop="yanzhengma">
          <el-input v-model="ruleForm.yanzhengma"               placeholder="验证码" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if((!this.ruleForm.yanzhengma)&& 'yonghu'==this.flag){
